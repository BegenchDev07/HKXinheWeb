...
#     description: |
#       HK Xinhe Group.agency@mail.com
#       HK Xinhe Group.agency@support.com
#     button:
#       # Refer to the `sharedButton` schema in `src/sections.schema.ts` for all available configuration options (e.g., enable, label, url, hoverEffect, variant, icon, tag, rel, class, target, etc.)
#       enable: true
#       label: "Send Message"
#       url: "mailto:HK Xinhe Group.agency@mail.com"
#       # hoverEffect: "" # Optional: text-flip | creative-fill | magnetic | magnetic-text-flip
#       # variant: "" # Optional: fill | outline | text | circle
#       # rel: "" # Optional
#       # target: "" # Optional
...
form:
  emailSubject: "New form submission from HK Xinhe Group website" # Customized email subject (applicable when anyone submit form, form submission may receive by email depend on provider)
  submitButton:
    # Refer to the `sharedButton` schema in `src/sections.schema.ts` for all available configuration options (e.g., enable, label, url, hoverEffect, variant, icon, tag, rel, class, target, etc.)
    enable: true
    label: "SEND MESSAGE"
  ...
  inputs:
    ...
    - note: deprecated # info | warning | success | deprecated | hint
      ...
      content: Something went wrong! please use this mail - [HK Xinhe Group-astro-theme@gmail.com](mailto:HK Xinhe Group-astro-theme@gmail.com) to submit a ticket!
---
